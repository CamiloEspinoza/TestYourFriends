...
import { ArrowLeft, ArrowRight, RotateCcw, Sparkles, User } from "lucide-react";
          ...
          <CardContent className="space-y-4">
            <div className="rounded-lg border p-4 space-y-2">
              ...
              <ul className="text-sm text-muted-foreground space-y-1">
                <li>- Tu perfil ético basado en 4 dimensiones</li>
                <li>- Qué personaje histórico comparte tu filosofía</li>
                <li>- Cómo piensas frente a situaciones complejas</li>
              </ul>
            </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-3">
              <p className="text-sm font-medium">Tu perfil ético:</p>
              {(
